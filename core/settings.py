...
DATABASES = {
  'default': {
    ...
    'NAME': 'ecom-django',
    'USER': 'ecom-django_owner',
    'PASSWORD': 'ojnwAu1yipc8',
    'HOST': 'ep-wandering-truth-a1jiprg4.ap-southeast-1.aws.neon.tech',
...
REST_FRAMEWORK = {
    ...
    # ),
    # 'DEFAULT_RESPONSE_CLASS': 'core.custome_response.CustomResponse'
}
